...
function Hero() {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen mx-auto'>
      <div className='p-5 mt-1 max-w-[1000px] mx-auto'>
        ...
        <p className='text-lg text-white mt-4'>I’m an Android developer specialized in building exceptional digital experiences.
At the moment I'm interested in learning more about Kotlin and React Native applications. </p>
